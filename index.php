        ...
        <div class="row gy-4 d-flex justify-content-between">
          ...
          >
            ...
            <form
              ...
              method="POST"
            >
              <input type="text" class="form-control" style="font-size: 1.1rem;" placeholder="Your Link" id="originalLink" />
                            ...
                            if (regexp.test(originalLink)){
                                ...
                                generateShorty.innerHTML=`
                                                          <form
                                                                ...
                                                                data-aos-delay="200"
                                                          >
                                                                <input type="text" id="shortInput" disabled style="font-size: 1.1rem;" disbaled class="form-control" placeholder="" value="<?php echo $siteName?>${avail}"/>
